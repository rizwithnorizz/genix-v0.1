    ...
    const [schedule, setSchedule] = useState<Schedule[]>([
        {
            ...
            content: "Class Schedule 03/26/2025",
        },
        {
            id: 2,
            name: "Generated Schedule",
            content: "Class Schedule 04/27/2025",
        },
        {
            id: 3,
            name: "Generated Schedule",
            content: "Class Schedule 06/15/2025",
        },
        {
            id: 4,
            name: "Generated Schedule",
            content: "Class Schedule 06/29/2025",
        },
    ]);
            ...
            <main className="col-span-3 space-y-4">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 gap-4 ">
                    <div className="bg-white p-4 rounded-2xl shadow-lg md:row-start-1 s:h-70">
                            ...
                            {schedule.map((schedule, idx) => (
                                ...
                                >
                                    ...
                                    <div className="flex gap-2">
                                        <button className="bg-green-500 text-white rounded-3xl p-2">
                                            View File
                                        </button>
                                        <button className="bg-red-800 text-white rounded-3xl p-2">
                                            Delete File
                                        </button>
                                    </div>
                                </div>
                        ...
                        <button className="mt-10 bg-black text-white py-2 px-4 rounded-lg ">
