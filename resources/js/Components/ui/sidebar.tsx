      ...
      <SidebarContext.Provider value={contextValue}>
        ...
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar pr-8",
              className
            )}
            ref={ref}
            {...props}
...
>(({ className, ...props }, ref) => (
  <li
    ...
    className={cn("group/menu-item relative h-[4rem] flex items-center justify-center", className)}
    {...props}
  />
))
